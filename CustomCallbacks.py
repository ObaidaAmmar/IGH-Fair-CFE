...
class SaveOnBestTrainingRewardCallback(BaseCallback):
    ...
    def __init__(self, check_freq: int, log_dir: str, verbose=1):
        ...
        self.custom_writer1 = SummaryWriter("./counterfactuals_/Rew/")
        self.custom_writer2 = SummaryWriter("./counterfactuals_/Rew_Mean/") 
    ...
    def _on_step(self) -> bool:
        ...
        if self.locals['dones'][0]:
            ...
            normalized_ep_reward = self.total_reward / self.steps_in_episode
            last_ep_reward = self.locals['rewards'][0] 

            # Log the normalized reward to TensorBoard (under custom metrics)
            self.custom_writer1.add_scalar("ep_rew", last_ep_reward, self.num_timesteps)
            self.custom_writer2.add_scalar("ep_rew_mean", normalized_ep_reward, self.num_timesteps)
